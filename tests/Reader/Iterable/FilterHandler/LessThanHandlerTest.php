...
use Yiisoft\Data\Tests\Common\Reader\FilterHandler\BaseLessThanHandlerWithReaderTest;

final class LessThanHandlerTest extends BaseLessThanHandlerWithReaderTest
{
    use ReaderTrait;
